 ...
 * 					메소드명(----)		메소드 호출 후 데이터를 전송했을 경우에 생성되는 변수
 * 									*** 사용자의 요청값을 받는 경우
 * 									void display(int a)
 * 									{
 * 									}
...
public class 변수종류_1 {
	...
	public static void main(String[] args) {
		 ...
		 * 	클래스 변수는 저장 공간이 1개만 생성되기 때문에 항상 같은 값을 유지한다
		 */
	}
