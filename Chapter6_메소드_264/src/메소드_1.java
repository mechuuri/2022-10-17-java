 ...
 *          리턴형 메소드명(매개변수...)
 *          {
 *             return 값; ==> 생략이 가능  ===> 결과값 (없눈 경우 => void => return 생략이 가능)
 *          }
 *       2) 정적 (static)
 ...
 *               ----------------------  -----------
 *                Call By Value(실제 값)   Call By Reference(주소)
 *       
 */
class Names{
	String name1;
...
public class 메소드_1 {
	...
	// Names n=new Names();  ==>  Names name=n;
	...
	public static void main(String[] args) {
        ...
        // x,y메모리 ==> 메소드 호출 (매개변수 다른 메모리가 생성) => 복사본 (원본은 그대로 복사본안에서반 변경)
