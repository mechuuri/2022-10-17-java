 ...
 * 			= 선택 조건문 : 조건 true, false일 경우 처리하는 문장을 따로 만들어서 처리 
 * 			= 다중 조건문 : 조건이 여러개일 경우에 처리하는 문장
 ...
 * 		= 조건문
 * 			1) 단일 조건문
 * 				if(조건) =====> 부정연산자, 비교연산자, 논리연산자 중에 1개를 선택해야 함 (true/false)
 * 							  ---------------------------
 ...
 * 				==> if(조건)
 * 						수행문장 1
 * 						수행문장 2  ===> 무조건 수행하는 문장 (if문 소속문장이 아니기 때문)
 * 						================== 조건 false면 수행문장 2
 * 										      조건 true 	 수행문장1, 수행문장 2
