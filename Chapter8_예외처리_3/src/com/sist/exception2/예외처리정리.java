 ...
 * ---------
 * 	1. 프로그래머의 실수
 * 	2. 사용자의 실수 (입력값을 줄 때) ==> 유효성 검사 (자바스크립트)
 * -------------------------------------------------
 * 	3. 오작동 / 비정상 종료
 * ------------------------에러 / 오류
 * 	
 ...
 * 	==> 컴파일 에러 / 실행시 에러(런타임 에러)
 * 		ㄴ CheckedException	  ㄴ UnCheckException : 예외처리 필수(선택)
 * 			: 컴파일러가 확인 (반드시 예외처리를 해야된다)
 ...
 * 				-------------------------------> 객체지향 프로그램
 * 		2. 최적화 : 실행속도를 빠르게 만든다
 * 				웹에서 최적화(데이터전송 속도와 화면 출력속도)
 * 									 ----------- React, Vue
 * 		3. 견고함 : 에러에 대응을 할 수 있는 프로그램 => 예외처리
 * 
 * 	==> 예외처리 방법
